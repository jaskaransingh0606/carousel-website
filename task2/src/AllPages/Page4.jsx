...
function Page4() {
  return (
    <div className='flex flex-row h-screen w-screen md:flex-col-reverse relative'>
      ...
      <div className=' flex flex-col w-2/4 space-y-16 md:h-3/6 md:w-screen bg-purple-800 justify-end  '>

        <div className='flex flex-col space-y-6 mb-10 md:-mb-8  pl-16'>
          <div className=''><img className='' src={worldAward}></img></div>
